...
export class Init1776901890057 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_ai_processed_exam_questions_status" ON "ai_processed_exam_questions" ("status") `,
    );
    await queryRunner.query(
      `CREATE TABLE "invalid_exam_questions" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "paper_id" uuid NOT NULL, "page_number" integer NOT NULL, "raw_text" text NOT NULL, "errors" text array NOT NULL DEFAULT '{}', CONSTRAINT "PK_2b16a23acc1668144e1e6b5e6e3" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_invalid_exam_questions_paper_id" ON "invalid_exam_questions" ("paper_id") `,
    );
    await queryRunner.query(
      `ALTER TABLE "exam_papers" ADD CONSTRAINT "FK_72a67dbeaa160490f87d90b7463" FOREIGN KEY ("exam_type_id") REFERENCES "exam_types"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "exam_papers" ADD CONSTRAINT "FK_305e58ec5bf1892d0f8db11b867" FOREIGN KEY ("subject_id") REFERENCES "subjects"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "documents" ADD CONSTRAINT "FK_dcd2bcc8c4615c4eb3edb00061f" FOREIGN KEY ("exam_paper_id") REFERENCES "exam_papers"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "documents" ADD CONSTRAINT "FK_deb6419eca6011ec947aa3bfffc" FOREIGN KEY ("question_id") REFERENCES "exam_questions"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "exam_questions" ADD CONSTRAINT "FK_41579a7ff9d612e4eb960906382" FOREIGN KEY ("exam_paper_id") REFERENCES "exam_papers"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "exam_questions" ADD CONSTRAINT "FK_284f70221ec312199037fddc7fc" FOREIGN KEY ("subject_id") REFERENCES "subjects"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "ai_processed_exam_questions" ADD CONSTRAINT "FK_15acf7368f8d2cdf4fa896c3cf5" FOREIGN KEY ("exam_question_id") REFERENCES "exam_questions"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "ai_processed_exam_questions" DROP CONSTRAINT "FK_15acf7368f8d2cdf4fa896c3cf5"`,
    );
    await queryRunner.query(
      `ALTER TABLE "exam_questions" DROP CONSTRAINT "FK_284f70221ec312199037fddc7fc"`,
    );
    await queryRunner.query(
      `ALTER TABLE "exam_questions" DROP CONSTRAINT "FK_41579a7ff9d612e4eb960906382"`,
    );
    await queryRunner.query(
      `ALTER TABLE "documents" DROP CONSTRAINT "FK_deb6419eca6011ec947aa3bfffc"`,
    );
    await queryRunner.query(
      `ALTER TABLE "documents" DROP CONSTRAINT "FK_dcd2bcc8c4615c4eb3edb00061f"`,
    );
    await queryRunner.query(
      `ALTER TABLE "exam_papers" DROP CONSTRAINT "FK_305e58ec5bf1892d0f8db11b867"`,
    );
    await queryRunner.query(
      `ALTER TABLE "exam_papers" DROP CONSTRAINT "FK_72a67dbeaa160490f87d90b7463"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_invalid_exam_questions_paper_id"`,
    );
    await queryRunner.query(`DROP TABLE "invalid_exam_questions"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_ai_processed_exam_questions_status"`,
    );
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_exam_questions_paper_status"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_284f70221ec312199037fddc7f"`,
    );
    await queryRunner.query(`DROP TABLE "exam_questions"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_dcd2bcc8c4615c4eb3edb00061"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_subjects_name_department"`,
    );
