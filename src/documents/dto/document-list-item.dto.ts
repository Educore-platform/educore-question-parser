...
import { CloudinaryStatus, DocumentSource, DocumentType } from '../../model/entities/enums';
...
export class DocumentListItemDto {
  ...
  @ApiPropertyOptional({ enum: CloudinaryStatus, nullable: true }) cloudinaryStatus: CloudinaryStatus | null;
